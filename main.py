...
async def main():
    async with async_playwright() as p:
        ...
        await portal.close_newsletter_popup()
        await portal.navigate_to_wishlist()
        await portal.navigate_to_home()
        await portal.close_newsletter_popup() """
        
        await portal.scroll_down()
        await portal.scroll_down()
        
        await portal.quick_view_product()
        
        """ await portal.quick_add_product()
        await portal.select_product_options_and_add_to_cart() """
        
        """ await portal.navigate_to_cart() """
