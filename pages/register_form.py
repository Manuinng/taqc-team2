...
class RegisterForm:
    ...
    async def fill_registration_form(self, first_name=None, last_name=None, email=None, password=None):
        ...
        await self.page.wait_for_selector("form#register-form", timeout=5000)  # Reduce el tiempo de espera
        ...
        for selector, value in fields:
            if value:
                ...
                await self.page.locator(selector).wait_for(state="visible", timeout=3000)  # Reduce el tiempo de espera
                await self.page.fill(selector, value)
