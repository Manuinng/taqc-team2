...
async def test_success_product(setup_session):
...
@pytest.mark.asyncio(loop_scope="module")
async def test_fail_infinity_product(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_fail_NaN_product(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_fail_zero_product(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_fail_max_product(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_fail_negative_product(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_eliminate_compare(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_int_value_quantity(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_empty_product(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_buy_with(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_categories_button(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_compare_product_cart(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_find_size(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_wishlist_option(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
...
@pytest.mark.asyncio(loop_scope="module")
async def test_price_discount(setup_session):
    home = AutomationPortal(setup_session)
    await home.navigate()
    await home.close_newsletter_popup()
    product = ProductPage(setup_session)
